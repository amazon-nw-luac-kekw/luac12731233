...
function ButtonSimple:SetTextAlignment(value, durationOverride)
  local enumAlign
  local textWidth = 0
  local druation = durationOverride or self.mAnimPositionDuration
  ...
  if enumAlign ~= nil then
    ...
    self.ScriptedEntityTweener:Play(self.ButtonText, druation, {x = textPosX, ease = "QuadOut"})
  end
