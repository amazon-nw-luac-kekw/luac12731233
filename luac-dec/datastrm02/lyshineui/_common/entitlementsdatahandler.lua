      ...
      if entitlementData then
        for i = 1, #entitlementData.rewards do
          if entitlementData.rewardType == eRewardTypeEntitlement then
            ...
            if reward.rewardType == eRewardTypeService then
              reward.storeTab = eStoreTabServices
            end
...
function EntitlementsDataHandler:GetEntitlementDisplayInfo(rewardType, rewardId)
  ...
  elseif rewardType == eRewardTypeService then
    itemId = rewardId
    displayInfo.isValid = true
    displayInfo.tooltip = "@server_transfer_change_world"
    displayInfo.spritePath = "lyShineui/images/mtx/mtx_product_images/services_Square_ServerTransfer.dds"
    displayInfo.spritePathHiRes = "lyShineui/images/mtx/mtx_product_images/services_Rectangle_ServerTransfer.dds"
  end
  if itemId then
