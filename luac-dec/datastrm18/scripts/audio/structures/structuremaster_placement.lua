local structurePlacementScript = {
  Properties = {
    rootEntity = {
      default = EntityId(),
...
function structurePlacementScript:OnActivate()
...
function structurePlacementScript:OnDeactivate()
end
return structurePlacementScript
