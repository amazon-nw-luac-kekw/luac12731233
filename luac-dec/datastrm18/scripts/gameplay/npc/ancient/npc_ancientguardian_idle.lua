...
function NPC_AncientGuardian_Idle:OnActivate()
...
function NPC_AncientGuardian_Idle:OnDeactivate()
  self.meshNotificiationHandler:Disconnect()
  self:VFX_Off()
end
function NPC_AncientGuardian_Idle:VFX_On()
  self:VFX_Off()
...
function NPC_AncientGuardian_Idle:VFX_Off()
...
function NPC_AncientGuardian_Idle:OnMeshCreated()
  self:VFX_On()
end
return NPC_AncientGuardian_Idle
