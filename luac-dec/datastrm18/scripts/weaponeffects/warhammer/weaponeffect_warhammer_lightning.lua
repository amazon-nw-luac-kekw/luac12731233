...
WeaponEffect_Warhammer_Lightning = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Tip_01",
        particleName = "wFX_Lightning_Melee.Warhammer.Idle_01",
      ...
      },
      {
        ...
        startTriggerName = "Play_WPN_Warhammer_Lightning_Idle",
        stopTriggerName = "Stop_WPN_Warhammer_Lightning_Idle",
        preloadName = "Perks_Warhammer_Lightning"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Warhammer_Lightning_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Warhammer_Lightning_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_Warhammer_Lightning, WeaponEffectBase, true)
return WeaponEffect_Warhammer_Lightning
