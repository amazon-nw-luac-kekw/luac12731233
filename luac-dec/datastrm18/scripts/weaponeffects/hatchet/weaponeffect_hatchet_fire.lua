...
WeaponEffect_Hatchet_Fire = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Fire_Melee.Hatchet.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Fire_Melee.Hatchet.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
    ...
    melee_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Fire_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Fire_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_Hatchet_Fire, WeaponEffectBase, true)
return WeaponEffect_Hatchet_Fire
