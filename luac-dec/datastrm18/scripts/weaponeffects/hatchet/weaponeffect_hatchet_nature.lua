...
WeaponEffect_Hatchet_Nature = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Nature_Melee.Hatchet.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Nature_Melee.Hatchet.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Nature_Idle",
        stopTriggerName = "Stop_WPN_Hatchet_Nature_Idle",
        preloadName = "Perks_Hatchet_Nature"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Nature_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Nature_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_Hatchet_Nature, WeaponEffectBase, true)
return WeaponEffect_Hatchet_Nature
