...
WeaponEffect_Hatchet_Lightning = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Lightning_Melee.Hatchet.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Lightning_Melee.Hatchet.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Lightning_Idle",
        stopTriggerName = "Stop_WPN_Hatchet_Lightning_Idle",
        preloadName = "Perks_Hatchet_Lightning"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Lightning_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_Hatchet_Lightning_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_Hatchet_Lightning, WeaponEffectBase, true)
return WeaponEffect_Hatchet_Lightning
