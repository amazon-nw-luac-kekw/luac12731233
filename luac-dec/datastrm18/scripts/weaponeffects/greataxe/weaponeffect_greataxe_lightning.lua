...
WeaponEffect_GreatAxe_Lightning = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Lightning_Melee.GreatAxe.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Lightning_Melee.GreatAxe.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
      ...
      },
      {
        ...
        startTriggerName = "Play_WPN_GreatAxe_Lightning_Idle",
        stopTriggerName = "Stop_WPN_GreatAxe_Lightning_Idle",
        preloadName = "Perks_GreatAxe_Lightning"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Lightning_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Lightning_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_GreatAxe_Lightning, WeaponEffectBase, true)
return WeaponEffect_GreatAxe_Lightning
