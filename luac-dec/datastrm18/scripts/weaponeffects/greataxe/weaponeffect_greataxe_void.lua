...
WeaponEffect_GreatAxe_Void = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Void_Melee.GreatAxe.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Void_Melee.GreatAxe.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
      ...
      },
      {
        ...
        startTriggerName = "Play_WPN_GreatAxe_Void_Idle",
        stopTriggerName = "Stop_WPN_GreatAxe_Void_Idle",
        preloadName = "Perks_GreatAxe_Void"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Void_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Void_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_GreatAxe_Void, WeaponEffectBase, true)
return WeaponEffect_GreatAxe_Void
