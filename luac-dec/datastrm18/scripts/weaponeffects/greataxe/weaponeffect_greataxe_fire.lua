...
WeaponEffect_GreatAxe_Fire = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Fire_Melee.GreatAxe.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Fire_Melee.GreatAxe.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
      ...
      },
      {
        ...
        startTriggerName = "Play_WPN_GreatAxe_Fire_Idle",
        stopTriggerName = "Stop_WPN_GreatAxe_Fire_Idle",
        preloadName = "Perks_GreatAxe_Fire"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Fire_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Fire_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_GreatAxe_Fire, WeaponEffectBase, true)
return WeaponEffect_GreatAxe_Fire
