...
WeaponEffect_GreatAxe_Ice = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Ice_Melee.GreatAxe.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Ice_Melee.GreatAxe.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
      ...
      },
      {
        ...
        startTriggerName = "",
        stopTriggerName = "",
        preloadName = "Perks_GreatAxe_Ice"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Ice_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Ice_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_GreatAxe_Ice, WeaponEffectBase, true)
return WeaponEffect_GreatAxe_Ice
