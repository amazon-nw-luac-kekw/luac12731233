...
WeaponEffect_GreatAxe_Nature = {
  effectGroups = {
    idle = {
      {
        type = WeaponEffectBase.EffectTypes.Particle,
        attachmentName = "vfx_Mid_01",
        particleName = "wFX_Nature_Melee.GreatAxe.Idle_01",
      ...
      },
      {
        ...
        particleName = "wFX_Nature_Melee.GreatAxe.Idle_02",
        followType = EmitterFollow,
        killOnStop = true
      },
      {
      ...
      },
      {
        ...
        startTriggerName = "Play_WPN_GreatAxe_Nature_Idle",
        stopTriggerName = "Stop_WPN_GreatAxe_Nature_Idle",
        preloadName = "Perks_GreatAxe_Nature"
      }
    },
    melee_1 = {
      {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Nature_Melee",
        stopTriggerName = "",
        preloadName = ""
      }
    },
    melee_charged_1 = {
      ...
      {
        type = WeaponEffectBase.EffectTypes.Audio,
        startTriggerName = "Play_WPN_GreatAxe_Nature_Melee_Charged",
        stopTriggerName = "",
        preloadName = ""
      }
    },
...
Merge(WeaponEffect_GreatAxe_Nature, WeaponEffectBase, true)
return WeaponEffect_GreatAxe_Nature
